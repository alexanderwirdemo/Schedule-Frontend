...
export class UserComponent implements OnInit {
  ...
  addEvent2() {
    ...
    formData.append("calendar_event", calendar_event);
  ...
  addEvent(reservation: any, row: any) {
    ...
    let token = "3755~ChBIrv7NivgkFdngZlQY72e1tfFz50eY5SJi9eqqoSk6Sd8pgTz47w0AZkNE8yPb";
    let url = "https://ltu.instructure.com/api/v1/calendar_events.json";
    ...
    this._http.post<any>(url, this.formData, { headers: headers }).subscribe(data => {
      console.dir(data);
    });
  }
}
